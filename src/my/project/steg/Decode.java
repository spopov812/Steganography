...
/**
 * 
 * Blueprint for a decoder object that takes a steganographic image and decodes
...
public class Decode {
	...
	/**
	 * 
	 * Constructor for a decoder object that takes in a steganographic image.
	 * 
	 * @param imageStr
	 *            png image that is actually a steganographic image.
	 * @throws IOException
	 */
	...
	/**
	 * 
	 * Decodes the file size of the encoded image from the first 6 pixels. From
	 * there, the method know what the interval between encoded pixels is and
	 * reads that data.
	 * 
	 */
	public void makeText() {
		...
		// decodes the data in the image based off the interval between encoded
		// pixels
	...
	/**
	 * 
	 * Decodes the encoded pixels offset by an interval after the first six
	 * pixels.
	 * 
